...
print("Your unique hobbies are: " + ", ".join(unique_hobbies))
...
try:
    age_number = int(user_data["age"])
    current_year = 2023  # or use datetime for current year
    birth_year = current_year - age_number
    print("You were born in: " + str(birth_year))
except:
    print("Invalid age entered, can't calculate birth year.")
...
def create_summary(data):
    return f"{data['name']} is {data['age']} years old and likes {', '.join(data['hobbies'])}."
